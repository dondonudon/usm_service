...
class Laporan_tukang_model extends CI_Model
{
    ...
    //var $table = 'customers';
    public $column_order  = array('spk.datetime'); //set column field database for datatable orderable
    ...
    private function _get_datatables_query()
    {
        ...
        if ($this->input->post('tgl_a') && $this->input->post('tgl_b')) {
            $this->db->where('spk.datetime >=', $tgl_a);
            $this->db->where('spk.datetime <=', $tgl_b);
        }
    ...
    public function get_datatables()
    {
        ...
        $query = $this->db->get();
        //$query = $this->db->query("SELECT t.nospk, t.kode_m_kasir, t.jumlah, DATE(t.datetime) as datetime, mk.nama FROM trans t INNER JOIN master_kasir mk ON t.kode_m_kasir=mk.kode_m_kasir");
        return $query->result();
    }
