    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA SPK</h3>
			...
			<tr>
				<td width="100px">No Transaksi</td>
					<?php $notrans = $_SESSION['id_users'] . "" . nospk();?>
				<td width="100px">
					<?php echo $notrans; ?></td>
			...
			<tr>
				...
				<td colspan="3"><input type="text" class="form-control" name="nama" id="nama" placeholder="Nama" required></td>
            </tr>
            <tr>
				<td>Alamat</td>
				<td colspan="3"><input type="text" class="form-control" name="alamat" id="alamat" placeholder="Alamat" required></td>
            </tr>
            <tr>
				<td>No Telp</td>
                <td><input type="text" class="form-control" name="telp" id="telp" placeholder="No Telp" required></td>
                <td>Jenis AC</td>
				<td><input type="text" class="form-control" name="jenis" id="jenis" placeholder="Jenis AC" required></td>
            </tr>
            <tr>
				<td>Tipe Pelayanan</td>
                <td><input type="text" class="form-control" name="tipe" id="tipe" placeholder="Tipe Pelayanan" required></td>
                <td>Keterangan</td>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		function tampil_data_barang(){
		    $.ajax({
		        type  : 'GET',
		        url   : '<?php echo base_url() ?>spk/data_barang',
		        async : true,
		        dataType : 'json',
		...
		$('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('spk/get_barang') ?>",
                dataType : "JSON",
                data : {id:id},
                success: function(data){
		...
		$('#btn_simpan').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('spk/simpan_barang') ?>",
                dataType : "JSON",
		...
		$('#btn_update').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('spk/update_barang') ?>",
                dataType : "JSON",
        ...
        $('#btn_hapus').on('click',function(){
            ...
            $.ajax({
            type : "POST",
            url  : "<?php echo base_url('spk/hapus_barang') ?>",
            dataType : "JSON",
                    data : {id: id},
                    success: function(data){
