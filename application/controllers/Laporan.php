...
class Laporan extends CI_Controller
{
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $customers) {
            ...
            $row[]  = '<a class="btn btn-sm btn-primary" href="' . base_url('laporan/print/' . $customers->nospk) . '" title="Edit" target="_blank">Print</a>';
            $data[] = $row;
    ...
    public function pdf()
    {
        ...
        $nourut = 1;
        foreach ($this->Laporan_model->excel($tanggal_a, $tanggal_b) as $data) {
